...
using ParallexTask1.Repository;
using ParallexTask1.Service;
using ParallexTask1.shared;
using System.Text;

namespace ParallexTask1.Extension
{
    public static class ServiceExtensions
    {
        // method enable cors to allow access to request from another domain
       ...
       opts.UseSqlServer(configuration.GetConnectionString("sqlConnection")));
        ...
        public static void ConfigureSwaggerAuthorizationSupport(this IServiceCollection services)
        {
